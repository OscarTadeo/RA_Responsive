...
public:
    ...
    static constexpr int IMAGE_TARGET_ID_2 = 1;
    ...
    //void initAR(const InitConfig& initConfig, int target, int target2);
...
private: // data members
    ...
    int mTarget2 = IMAGE_TARGET_ID_2;
    ...
    VuObserver* mObjectObserver2 = nullptr;
